...
Path.prototype.getHermitePoint = function(f, out)
{
	...
	if(!RD.EvaluateHermiteSplineVector)
		throw("it requires rendeer-animation.js");
	RD.EvaluateHermiteSplineVector( p0, p1, pre_p0, post_p1, t, out );
	return out;
}
...
Spline.prototype._ctor = function()
{
...
Spline.prototype.render = function(renderer, camera)
{
	if(	this.must_update )
		this.updateMesh();
}
...
extendClass( Spline, RD.SceneNode );
RD.Spline = Spline;
*/
