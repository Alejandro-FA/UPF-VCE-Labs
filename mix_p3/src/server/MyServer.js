...
class MyServer {
    ...
    constructor() {
        ...
        //Ruta por defecto de archivos estáticos
        app.use(express.static('../client'));

        //Para leer el archivo de world.json
        ...
        //On request == on_connection
        //Quan algú es connecta a la url del websocketserver
    ...
    on_connection (req) {
        ...
        let ws = req.accept() //Acceptes la request de connexió!!
        ...
        //NOTA RAQUEL: esto ya no lo necesitamos, creo... porque lo hace la webpage directamente
        /*if(ws.room == "register") {
            ...
            ws.send(JSON.stringify(msg)) //Envias info al user!! 
            return
        }*/
